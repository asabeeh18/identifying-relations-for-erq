...
public class Splitter {
    ...
    static BufferedWriter redirectWriter,
            infoboxWriter,
            contentWriter,
            wastedWriter;
    static int infoboxChars = 0,
                redirectChars = 0,
                contentChars = 0;
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, Exception
    {
        ...
        out.println("Job No: "+id+" Start: "+start+" End: "+end+" TIME: "+begin);
        ...
        out.println("Total Time Taken: "+(finish.compareTo(begin)));
        out.close();
    }
    ...
    public static void split() throws FileNotFoundException, IOException
    {
        ...
        final int MAX_CHAR_PER_FILE = 67000000; //actually +800
